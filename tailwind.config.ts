  ...
  theme: {
    ...
    extend: {
      colors: {
        ...
        // max — мессенджер Макс. Его логотип — сине-фиолетовый градиент;
        // для плоских кнопок сайта берём один цвет из середины градиента,
        // чтобы кнопка отличалась от синего Telegram и не спорила с брендом.
        max: {
          DEFAULT: "#6C33E8",
          hover: "#5A27CC",
        },
