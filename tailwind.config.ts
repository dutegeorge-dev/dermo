  ...
  theme: {
    ...
    extend: {
      colors: {
        ...
        // max — мессенджер Макс. В его логотипе сине-фиолетовый градиент
        // (#4cf → #53e → #93d); для плоских кнопок сайта берём средний
        // стоп #53e, чтобы кнопка не спорила с синим Telegram.
        max: {
          DEFAULT: "#5533EE",
          hover: "#4526CC",
        },
