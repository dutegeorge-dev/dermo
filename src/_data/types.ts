...
export interface ServiceLink {
  ...
  textKey: string;
  /**
   * URL страницы услуги. Без него плитка рендерится как обычный блок, без
   * ссылки и «Подробнее» — так показываем услуги, которые сейчас не продвигаем.
   */
  url?: string;
}
...
export interface ServicePageConfig {
  ...
  caseUrl?: string;
  /**
   * Явная перелинковка «полезный материал» в конце страницы услуги (URL статьи
   * ИЛИ кейса, ru-канонический путь). Приоритетнее авто-связки library.byService.
   * Заголовок берётся из библиотеки контента (library.byUrl).
   */
