...
const en: Dictionary = {
  ...
  mega: {
    ...
    byCity: "[EN] По городу",
    allServices: "[EN] Посмотреть все услуги",
  },
  method: {
    avto: "[EN] Авто",
    zhd: "[EN] ЖД",
  ...
  methodFull: stubBranch(ru.methodFull, "[EN] "),
  ...
  city: {
    ...
    nsk: "[EN] Новосибирск",
    kazan: "[EN] Казань",
    blagoveshchensk: "[EN] Благовещенск",
  },
  trade: {
  ...
  // EN-страница физически не генерируется (в данных есть URL/пути к лого,
