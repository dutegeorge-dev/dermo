...
const en: Dictionary = {
  ...
  home: {
    ...
    trust: {
      ...
      whiteValue: "[EN] Белая доставка",
      whiteLabel: "[EN] полный пакет документов и ГТД",
      bankValue: "[EN] ВТБ",
      bankLabel: "[EN] банк-партнёр",
      suppliersValue: "[EN] Проверенные поставщики",
      suppliersLabel: "[EN] прямые контракты с заводами",
    },
    about: {
      title: "[EN] Кто мы",
